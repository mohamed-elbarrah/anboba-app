...
const copy: Record<Locale, DashboardCopy> = {
  en: {
    overview: "Overview", pages: "Pages", faq: "FAQ", forms: "Forms", media: "Media", messages: "Messages", settings: "Settings",
  ...
  ar: {
    overview: "نظرة عامة", pages: "الصفحات", faq: "الأسئلة الشائعة", forms: "النماذج", media: "الوسائط", messages: "الرسائل", settings: "الإعدادات",
